...
elgg_register_event_handler('init', 'system', 'tinymce_pro_init');

function tinymce_pro_init() {
	elgg_extend_view('css/elgg', 'tinymce/css');
	elgg_extend_view('css/admin', 'tinymce/css');

	elgg_register_js('tinymce', 'mod/tinymce_pro/vendor/tinymce/jscripts/tiny_mce/tiny_mce.js');
