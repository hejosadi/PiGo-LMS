...
%s",
		...
		// group invite
		'group_tools:groups:invite:title' => "Agregar estudiantes a la clase",
		'group_tools:groups:invite' => "Agregar estudiantes",
		...
		'group_tools:group:invite:users' => "Buscar Estudiantes",
		...
		'group_tools:group:invite:csv' => "Subir estudiantes usando nomina",
		'group_tools:group:invite:csv:description' => "Puedes agregar estudiantes mediante un archivo CSV con la nomina de estudiantes.<br />El formato debe ser: displayname;e-mail address.",

		'group_tools:group:invite:text' => "Texto de Invitacion (opcional)",
		'group_tools:group:invite:add:confirm' => "Are you sure you wish to add these users directly?",

		'group_tools:group:invite:resend' => "Reenviar invitaciones a los que han sido previamente invitados",
