...
elgg_register_event_handler('init', 'system', 'socialdocs_init');

function socialdocs_init() {

			global $CONFIG;
elgg_register_page_handler('socialdocs','page_handler_socialdocs');
...
function expages_public_pages($hook, $type, $return_value, $params) {
	$allowed_pages = array();
	$allowed_pages[] = 'socialdocs/*.*/*.*';
	return $allowed_pages; 
}
function page_handler_socialdocs($page) {
