...
echo '<textarea name="'.$vars['internalname'].'">'.$textval.'</textarea>
		...
		CKEDITOR.config.toolbar_Fullest'.$rand.'=[[\'Bold\',\'Italic\',\'Underline\',\'Strike\',\'-\',\'Subscript\',\'Superscript\'],[\'NumberedList\',\'BulletedList\',\'-\',\'Outdent\',\'Indent\'],[\'Link\',\'Unlink\',\'Anchor\',\'Image\',\'Table\',\'HorizontalRule\',\'Smiley\',\'SpecialChar\'],[\'Format\',\'Font\',\'FontSize\'],[\'TextColor\']];
		CKEDITOR.config.toolbar=\'Fullest'.$rand.'\';
			
		var editor'.$rand.' = CKEDITOR.replace( \''.$vars['internalname'].'\',  {
        toolbar : \'Fullest'.$rand.'\',
        uiColor : \'#9AB8F3\',
        filebrowserUploadUrl : \''.$CONFIG->url.'CKEditorupload\'
    } );
