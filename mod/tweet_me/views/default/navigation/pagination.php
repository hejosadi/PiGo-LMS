...
if ($pages->prev['href']) {
	...
	echo "<li class=\"elgg-state-disabled\"><a href=\"#\">{$pages->prev['text']}</a></li>";
}

foreach ($pages->items as $page) {
	if ($page == $current_page) {
		echo "<li class=\"elgg-state-selected\"><a href=\"#\">$page</a></li>";
	} else {
...
if ($pages->next['href']) {
	...
	echo "<li class=\"elgg-state-disabled\"><a href=\"#\">{$pages->next['text']}</a></li>";
}
