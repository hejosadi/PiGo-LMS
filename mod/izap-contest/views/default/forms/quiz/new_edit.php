...
// this is the form for editing the quiz
  ...
  <form action="<?php echo IzapBase::getFormAction('quiz_save', GLOBAL_IZAP_CONTEST_PLUGIN) ?>" method="post" enctype="multipart/form-data">
    ...
    <p>
      <label>
        ...
        <?php echo elgg_view("input/longtext", array("name" => "attributes[_title]", "value" => $quiz_entity->title)) ?>
      </label>
    </p>
    ...
    <?php if (!$vars['quiz_entity']) {
      ...
      <div id="option-array">
        <p id="option1">
          ...
          <a id="addmore" href="#">Agregar mas</a>
        </p>
      </div>
